const initialV={
    worrds:[
        ...
        {word:"bail",translate:"kaucja,poręczenie", id:Math.ceil(Math.random()*100)},
...
const wordsReducer=(state=initialV,action)=>{
    switch(action.type){
        case "add":
            return  {...state,worrds:[...state.worrds,{word:action.payload1,translate:action.payload2,id:action.payload3,important:action.payload4}]}
            case "sub":
